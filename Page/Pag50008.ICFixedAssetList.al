/*-------------------------------------------------DOCUMENTATION-------------------------------------------------------------------
Since not all users will have access to the main company where FAs are held, this page was created to retrieve only fixed assets 
currently linked to the customers of the company the user is running this page from.
---------------------------------------------------------------------------------------------------------------------------------*/
