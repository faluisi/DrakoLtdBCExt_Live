        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DueDate_SalesInvHdr; Format("Sales Invoice Header"."Due Date", 0, '<Day,2>-<Month Text,3>-<Year4>'))
                    {
                    }
                    ...
                    column(DocDate_SalesInvHdr; Format("Sales Invoice Header"."Document Date", 0, '<Day,2>-<Month Text,3>-<Year4>'))
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(Period_Start; Format("Period Start", 0, '<Day,2>-<Month Text,3>-<Year4>'))
                        { }
                        column(Period_End; Format("Period End", 0, '<Day,2>-<Month Text,3>-<Year4>'))
                        { }
                        //BFT-001 -- end
