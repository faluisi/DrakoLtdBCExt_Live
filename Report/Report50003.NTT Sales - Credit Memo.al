        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DueDate; Format("Sales Cr.Memo Header"."Due Date", 0, '<Month Text,3> <Day>, <Year4>'))
                    {
                    }
                    ...
                    column(DocDt_SalesCrMemoHeader; Format("Sales Cr.Memo Header"."Document Date", 0, '<Month Text,3> <Day>, <Year4>'))
                    {
                    }
                    ...
                    { }
                    column(ContractCode; "Sales Cr.Memo Header"."Contract Code")
                    { }
                    column(HasSite; HasSite)
                    { }
                    column(VATRegNo; "Sales Cr.Memo Header"."VAT Registration No.")
                    { }
                    column(CurrCode; CurrCap)
                    { }
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        column(VATP; "Sales Cr.Memo Line"."VAT %")
                        { }
                        column(Period_Start; Format("Sales Cr.Memo Line"."Period Start", 0, '<Month Text,3> <Day>, <Year4>'))
                        { }
                        column(Period_End; Format("Sales Cr.Memo Line"."Period End", 0, '<Month Text,3> <Day>, <Year4>'))
                        { }
