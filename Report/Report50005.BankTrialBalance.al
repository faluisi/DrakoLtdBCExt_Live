report 50005 "Bank Trial Balance"
{
    ...
    dataset
    {
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            column(Period_Cptn; Period_Cptn) { }
            column(CompanyName_Cptn; CompanyName_Cptn) { }
            column(AccountNo_Cptn; AccountNo_Cptn) { }
            column(Currency_Cptn; Currency_Cptn) { }
            column(OpenBal_Cptn; OpenBal_Cptn) { }
            column(NC11_Cptn; NC11_Cptn) { }
            column(NCP_Cptn; NCP_Cptn) { }
            column(CloseBal_Cptn; CloseBal_Cptn) { }
            column(DR_Cptn; DR_Cptn) { }
            column(CR_Cptn; CR_Cptn) { }
            column(CurrRecap_Cptn; CurrRecap_Cptn) { }
            column(Total_Cptn; Total_Cptn) { }
            column(CompanyName; CompanyName) { }
            column(BankCurr; "Currency Code") { }
            column(LCY; GLS."LCY Code") { }
            column(Op1BalLCY; BLE_Op1BalLCY) { }
            column(Op1BalFCY; BLE_Op1BalFCY) { }
            column(startdate; startdate) { }
            column(showFCY; showFCY) { }
            column(NCP_CR_FCY; NCP_CR_FCY) { }
            column(NCP_CR_LCY; NCP_CR_LCY) { }
            column(NCP_DR_FCY; NCP_DR_FCY) { }
            column(NCP_DR_LCY; NCP_DR_LCY) { }
            column(NC1_DR_FCY; NC1_DR_FCY) { }
            column(NC1_DR_LCY; NC1_DR_LCY) { }
            column(NC1_CR_FCY; NC1_CR_FCY) { }
            column(NC1_CR_LCY; NC1_CR_LCY) { }
            column(BLE_OPSBalLCY; BLE_OPSBalLCY) { }
            column(BLE_OPSBalFCY; BLE_OPSBalFCY) { }
            column(CloseBalFCY; CloseBalFCY) { }
            column(CloseBalLCY; CloseBalLCY) { }
            column(CloseBalLCY_DR; CloseBalLCY_DR) { }
            column(CloseBalLCY_CR; CloseBalLCY_CR) { }
            column(CloseBalFCY_DR; CloseBalFCY_DR) { }
            column(CloseBalFCY_CR; CloseBalFCY_CR) { }
            column(TotalOp1Bal; TotalOp1Bal) { }
            column(TotalNC1DR; TotalNC1DR) { }
            column(TotalNC1CR; TotalNC1CR) { }
            column(TotalOPSBal; TotalOPSBal) { }
            column(TotalNCPDR; TotalNCPDR) { }
            column(TotalNCPCR; TotalNCPCR) { }
            column(TotalCloseBalDR; TotalCloseBalDR) { }
            column(TotalCloseBalCR; TotalCloseBalCR) { }
            //column(FCYCurrencyTotalOP1; FCYCurrencyTotalOP1[CurrCount]) { }
            column(FCYCurrencyTotalOP11; FCYCurrencyTotalOP1[1]) { }
            column(FCYCurrencyTotalOP1_1; FCYCurrencyTotalOP1[1]) { }
            column(FCYCurrencyTotalNC1DR_1; FCYCurrencyTotalNC1DR[1]) { }
            column(FCYCurrencyTotalNC1CR_1; FCYCurrencyTotalNC1CR[1]) { }
            column(FCYCurrencyTotalOPS_1; FCYCurrencyTotalOPS[1]) { }
            column(FCYCurrencyTotalNCPDR_1; FCYCurrencyTotalNCPDR[1]) { }
            column(FCYCurrencyTotalNCPCR_1; FCYCurrencyTotalNCPCR[1]) { }
            column(FCYCurrencyTotalCloseDR_1; FCYCurrencyTotalCloseDR[1]) { }
            column(FCYCurrencyTotalCloseCr_1; FCYCurrencyTotalCloseCr[1]) { }
            column(FCYCurrencyTotalOP1_2; FCYCurrencyTotalOP1[2]) { }
            column(FCYCurrencyTotalNC1DR_2; FCYCurrencyTotalNC1DR[2]) { }
            column(FCYCurrencyTotalNC1CR_2; FCYCurrencyTotalNC1CR[2]) { }
            column(FCYCurrencyTotalOPS_2; FCYCurrencyTotalOPS[2]) { }
            column(FCYCurrencyTotalNCPDR_2; FCYCurrencyTotalNCPDR[2]) { }
            column(FCYCurrencyTotalNCPCR_2; FCYCurrencyTotalNCPCR[2]) { }
            column(FCYCurrencyTotalCloseDR_2; FCYCurrencyTotalCloseDR[2]) { }
            column(FCYCurrencyTotalCloseCr_2; FCYCurrencyTotalCloseCr[2]) { }
            column(FCYCurrencyTotalOP1_3; FCYCurrencyTotalOP1[3]) { }
            column(FCYCurrencyTotalNC1DR_3; FCYCurrencyTotalNC1DR[3]) { }
            column(FCYCurrencyTotalNC1CR_3; FCYCurrencyTotalNC1CR[3]) { }
            column(FCYCurrencyTotalOPS_3; FCYCurrencyTotalOPS[3]) { }
            column(FCYCurrencyTotalNCPDR_3; FCYCurrencyTotalNCPDR[3]) { }
            column(FCYCurrencyTotalNCPCR_3; FCYCurrencyTotalNCPCR[3]) { }
            column(FCYCurrencyTotalCloseDR_3; FCYCurrencyTotalCloseDR[3]) { }
            column(FCYCurrencyTotalCloseCr_3; FCYCurrencyTotalCloseCr[3]) { }
            column(FCYCurrencyTotalOP1_4; FCYCurrencyTotalOP1[4]) { }
            column(FCYCurrencyTotalNC1DR_4; FCYCurrencyTotalNC1DR[4]) { }
            column(FCYCurrencyTotalNC1CR_4; FCYCurrencyTotalNC1CR[4]) { }
            column(FCYCurrencyTotalOPS_4; FCYCurrencyTotalOPS[4]) { }
            column(FCYCurrencyTotalNCPDR_4; FCYCurrencyTotalNCPDR[4]) { }
            column(FCYCurrencyTotalNCPCR_4; FCYCurrencyTotalNCPCR[4]) { }
            column(FCYCurrencyTotalCloseDR_4; FCYCurrencyTotalCloseDR[4]) { }
            column(FCYCurrencyTotalCloseCr_4; FCYCurrencyTotalCloseCr[4]) { }
            column(LCYCurrencyTotalOP1_1; LCYCurrencyTotalOP1[1]) { }
            column(LCYCurrencyTotalNC1DR_1; LCYCurrencyTotalNC1DR[1]) { }
            column(LCYCurrencyTotalNC1CR_1; LCYCurrencyTotalNC1CR[1]) { }
            column(LCYCurrencyTotalOPS_1; LCYCurrencyTotalOPS[1]) { }
            column(LCYCurrencyTotalNCPDR_1; LCYCurrencyTotalNCPDR[1]) { }
            column(LCYCurrencyTotalNCPCR_1; LCYCurrencyTotalNCPCR[1]) { }
            column(LCYCurrencyTotalCloseDR_1; LCYCurrencyTotalCloseDR[1]) { }
            column(LCYCurrencyTotalCloseCr_1; LCYCurrencyTotalCloseCr[1]) { }
            column(LCYCurrencyTotalOP1_2; LCYCurrencyTotalOP1[2]) { }
            column(LCYCurrencyTotalNC1DR_2; LCYCurrencyTotalNC1DR[2]) { }
            column(LCYCurrencyTotalNC1CR_2; LCYCurrencyTotalNC1CR[2]) { }
            column(LCYCurrencyTotalOPS_2; LCYCurrencyTotalOPS[2]) { }
            column(LCYCurrencyTotalNCPDR_2; LCYCurrencyTotalNCPDR[2]) { }
            column(LCYCurrencyTotalNCPCR_2; LCYCurrencyTotalNCPCR[2]) { }
            column(LCYCurrencyTotalCloseDR_2; LCYCurrencyTotalCloseDR[2]) { }
            column(LCYCurrencyTotalCloseCr_2; LCYCurrencyTotalCloseCr[2]) { }
            column(LCYCurrencyTotalOP1_3; LCYCurrencyTotalOP1[3]) { }
            column(LCYCurrencyTotalNC1DR_3; LCYCurrencyTotalNC1DR[3]) { }
            column(LCYCurrencyTotalNC1CR_3; LCYCurrencyTotalNC1CR[3]) { }
            column(LCYCurrencyTotalOPS_3; LCYCurrencyTotalOPS[3]) { }
            column(LCYCurrencyTotalNCPDR_3; LCYCurrencyTotalNCPDR[3]) { }
            column(LCYCurrencyTotalNCPCR_3; LCYCurrencyTotalNCPCR[3]) { }
            column(LCYCurrencyTotalCloseDR_3; LCYCurrencyTotalCloseDR[3]) { }
            column(LCYCurrencyTotalCloseCr_3; LCYCurrencyTotalCloseCr[3]) { }
            column(LCYCurrencyTotalOP1_4; LCYCurrencyTotalOP1[4]) { }
            column(LCYCurrencyTotalNC1DR_4; LCYCurrencyTotalNC1DR[4]) { }
            column(LCYCurrencyTotalNC1CR_4; LCYCurrencyTotalNC1CR[4]) { }
            column(LCYCurrencyTotalOPS_4; LCYCurrencyTotalOPS[4]) { }
            column(LCYCurrencyTotalNCPDR_4; LCYCurrencyTotalNCPDR[4]) { }
            column(LCYCurrencyTotalNCPCR_4; LCYCurrencyTotalNCPCR[4]) { }
            column(LCYCurrencyTotalCloseDR_4; LCYCurrencyTotalCloseDR[4]) { }
            column(LCYCurrencyTotalCloseCr_4; LCYCurrencyTotalCloseCr[4]) { }
            column(indextoupdate; IndexToUpdate) { }
            column(showPHP; showPHP) { }
            column(showUSD; showUSD) { }
            column(showMX; showMX) { }
    ...
    begin
        ...
        for j := 1 to ArrayLen(FCYCurrencies) do begin
            if FCYCurrencies[j] = CurrCode then
                exit(i);
        end;
        exit(0);
    end;
