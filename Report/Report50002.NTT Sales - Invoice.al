report 50002 "NTT Sales - Invoice"
{
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(CustomerNo; g_Customer."No.")
            {
            }
            column(No_SalesInvHdr; ConvertStr("No.", '.', ' '))
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyInfoVATRegNo; CompanyInfo."TIN Number")
                    {
                    }
                    ...
                    column(VATRegNo_SalesInvHdr; g_Customer."VAT Registration No.")
                    {
                    }
                    //column(DueDate_SalesInvHdr; Format("Sales Invoice Header"."Due Date", 0, 4))
                    column(DueDate_SalesInvHdr; Format("Sales Invoice Header"."Due Date", 0, '<Month Text,3> <Day>, <Year4>'))
                    {
                    }
                    ...
                    column(DocDate_SalesInvHdr; Format("Sales Invoice Header"."Document Date", 0, '<Month Text,3> <Day>, <Year4>'))
                    {
                    }
                    ...
                    //BFT-001 -- begin
                    column(ContractCode; "Sales Invoice Header"."Contract Code")
                    { }
                    column(RFCaption; RFCCaption)
                    { }
                    column(InqEmail; InqEmail)
                    { }
                    column(CustomerRefCaption; CustomerRefCaption)
                    { }
                    column(CustomerCaption; CustomerCaption)
                    { }
                    column(AddressCaption; AddressCaption)
                    { }
                    column(InvoiceNumberCaption; InvoiceNumberCaption)
                    { }
                    column(DateCaption; DateCaption)
                    { }
                    column(CompanyInfoSWIFT; CompanyInfo."SWIFT Code")
                    { }
                    column(InquiriesCaption; InquiriesCaption)
                    { }
                    column(PhoneCaption; PhoneCaption)
                    { }
                    column(PaymentCaption; PaymentCaption)
                    { }
                    column(SWIFTCaption; SWIFTCaption)
                    { }
                    column(AccountCaption; AccountCaption)
                    { }
                    column(BankAddress; BankAddressCaption)
                    { }
                    column(VATIDNoCaption; VATIDNoCaption)
                    { }
                    column(TitleCaption; TitleCaption)
                    { }
                    column(SiteCaption; SiteCaption)
                    { }
                    column(IntBankCaption; IntBankCaption)
                    { }
                    column(IBANCaption; IBANCaption)
                    { }
                    column(BankCurrencyCaption; BankCurrencyCaption)
                    { }
                    column(FurtherTransferCaption; FurtherTransferCaption)
                    { }
                    column(PeriodStartCaption; PeriodStartCaption)
                    { }
                    column(PeriodEndCaption; PeriodEndCaption)
                    { }
                    column(CompanyInfoBankAddress; CompanyInfo."Bank Address")
                    { }
                    column(SIH_Currency; Curr2)
                    { }
                    column(HasVAT; HasVAT)
                    { }
                    column(SiteAddr1; SiteAddr[1])
                    { }
                    column(SiteAddr2; SiteAddr[2])
                    { }
                    column(SiteAddr3; SiteAddr[3])
                    { }
                    column(SiteAddr4; SiteAddr[4])
                    { }
                    column(SiteAddr5; SiteAddr[5])
                    { }
                    column(SiteAddr6; SiteAddr[6])
                    { }
                    column(SiteAddr7; SiteAddr[7])
                    { }
                    column(HasSite; HasSite)
                    { }
                    ...
                    { }
                    column(BankDetails6; BankDetails[6])
                    { }
                    column(BankDetails7; BankDetails[7])
                    { }
                    column(BankDetails8; BankDetails[8])
                    { }
                    column(HasBank; HasBank)
                    { }
                    column(HasIntBank; HasIntBank)
                    { }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(VATAmtLineVATAmtText; 'INPUT VAT')
                        {
                        }
                        ...
                        { }
                        column(SIL_VATP; "Sales Invoice Line"."VAT %")
                        { }
                        column(VATLinePrint; VATLinePrint)
                        { }
                        column(Curr1; Curr1)
                        { }
                        column(Curr2; Curr2)
                        ...
                        column(TotalAmountInclVATC1; TotalAmountInclVATC1)
                        {
                            AutoFormatExpression = 'USD';
                            AutoFormatType = 1;
                        }
                        column(TotalPaymentDiscOnVATC1; TotalPaymentDiscOnVATC1)
                        {
                            AutoFormatExpression = 'USD';
                            AutoFormatType = 1;
                        }
                        column(TotalAmountC1; TotalAmountC1)
                        {
                            AutoFormatExpression = 'USD';
                            AutoFormatType = 1;
                        }
                        column(TotalSubTotalC2; TotalSubTotalC2)
                        {
                            AutoFormatExpression = 'USD';
                            AutoFormatType = 1;
                        }
                        column(TotalInvDiscountAmountC2; TotalInvDiscountAmountC2)
                        {
                            AutoFormatExpression = 'USD';
                            AutoFormatType = 1;
                        }
                        column(TotalAmountVATC2; TotalAmountVATC2)
                        {
                            AutoFormatExpression = 'USD';
                            AutoFormatType = 1;
                        }
                        column(TotalAmountInclVATC2; TotalAmountInclVATC2)
                        {
                            AutoFormatExpression = 'USD';
                            AutoFormatType = 1;
                        }
                        column(TotalPaymentDiscOnVATC2; TotalPaymentDiscOnVATC2)
                        {
                            AutoFormatExpression = 'USD';
                            AutoFormatType = 1;
                        }
                        column(TotalAmountC2; TotalAmountC2)
                        {
                            AutoFormatExpression = 'USD';
                            AutoFormatType = 1;
                        }
                        ...
                        column(Period_Start; Format("Period Start", 0, '<Month Text,3> <Day>, <Year4>'))
                        { }
                        column(Period_End; Format("Period End", 0, '<Month Text,3> <Day>, <Year4>'))
                        { }
                        //BFT-001 -- end
        ...
        //BFT-001
        dataitem(TermsConditions; TermsConditions)
        {
            ...
            begin
                if ((g_Customer."Country/Region Code" = 'MX') OR (g_Customer."Country/Region Code" = 'PH')) then begin
                    if (TermsConditions.Country <> g_Customer."Country/Region Code") then
                        CurrReport.Skip();
                end
                else
                    if (TermsConditions.Country <> '') then
                        CurrReport.Skip();
            end;
        }
        //BFT-001
    ...
    local procedure SetReportCurrencies(var Currency1: Code[10]; var Currency2: Code[10]; SIH: Record "Sales Invoice Header")
    var
    ...
    //BFT-001 -- begin
    local procedure CalculateCurrencyTotals(var SIHeader: record "Sales Invoice Header"; Currency1: Code[10]; Currency2: Code[10])
    var
        GLSetup: Record "General Ledger Setup";
    begin
        GLSetup.get();
