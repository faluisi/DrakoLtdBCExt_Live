report 50001 CustBalancePerSite
{
    ...
    dataset
    {
        dataitem("Customer-Site"; "Customer-Site")
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                begin
                    ...
                    if not DimSetEntry.FindFirst() then
                        ...
                        if DimSetEntry."Dimension Value Code" <> "Customer-Site"."Site Code" then
                            CurrReport.Skip();
                    end;
            ...
            begin
                ...
                if "Customer-Site"."Customer No." <> '' then begin
                    ...
                    if CustPostingGrp <> '' then begin
                        if Cust."Customer Posting Group" <> CustPostingGrp then
                            CurrReport.Skip;
                    end;
                end;
